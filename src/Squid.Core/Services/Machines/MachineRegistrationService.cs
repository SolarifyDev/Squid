...
public interface IMachineRegistrationService : IScopedDependency
{
    ...
    Task<RegisterMachineResponseData> RegisterTentaclePollingAsync(RegisterTentaclePollingCommand command, CancellationToken cancellationToken = default);

    Task<RegisterMachineResponseData> RegisterTentacleListeningAsync(RegisterTentacleListeningCommand command, CancellationToken cancellationToken = default);
}
