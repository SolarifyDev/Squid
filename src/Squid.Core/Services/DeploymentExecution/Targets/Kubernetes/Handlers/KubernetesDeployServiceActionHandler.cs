...
public class KubernetesDeployServiceActionHandler : IActionHandler
{
    ...
    public Task<ActionExecutionResult> PrepareAsync(ActionExecutionContext ctx, CancellationToken ct)
    {
        ...
        {
            ScriptBody = KubernetesApplyCommandBuilder.Build("./service.yaml", ctx.Action, ScriptSyntax.Bash),
    ...
    /// with a stable semantic name (<c>k8s-apply</c>). The generated Service YAML is
    /// carried as a single <c>service.yaml</c> asset. Unconfigured or invalid actions
