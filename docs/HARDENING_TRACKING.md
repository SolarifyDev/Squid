...
_Last updated: 2026-04-25 (Phase-7 = B.5 + D.5 + D.6 + N3 + A.4 landed). Phase-6 = A.5 + A.11 + ARCH.7 + 2 new items (PollingTrustDistributor async, DeploymentLogWriter bounded channel). Phase-5 = B.6 + B.7 + T.11 + T.12. Phase-1..4 = remaining P0s. Update as items land._
