...
public sealed class WindowsServiceFixtureSmokeE2ETests
{
    ...
    private static string LocateTestServiceExe()
    {
        ...
        // From `tests/Squid.WindowsTentacleE2ETests/bin/<Config>/net9.0/`
        // the test service builds to
        // `tests/Squid.WindowsTentacleE2E.TestService/bin/<Config>/net9.0/SquidUpgradeE2ETestService.exe`.
        ...
        var testProjectDir = Path.GetDirectoryName(binDir)!;         // tests/Squid.WindowsTentacleE2ETests
        ...
        if (!File.Exists(candidate))
            throw new FileNotFoundException(
                ...
                $"Verify the project reference Squid.WindowsTentacleE2ETests → Squid.WindowsTentacleE2E.TestService " +
