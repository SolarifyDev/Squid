...
// at tests/Squid.LinuxTentacleE2ETests/Infrastructure/StubSquidServer.cs.
// Both implement the same Halibut-listener + REST-register surface; the
// only differences are namespace + minor host conventions (Linux's slim
// LinuxStubSquidServer companion handles register-only tests). Bug fixes
