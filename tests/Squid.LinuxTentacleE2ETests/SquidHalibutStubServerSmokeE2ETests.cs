...
/// <see cref="SquidHalibutStubServer"/> infrastructure port. Tier
...
/// from <c>Squid.WindowsUpgradeE2ETests</c> to the Linux project
...
/// SquidHalibutStubServer adds the full Halibut polling listener
...
public sealed class SquidHalibutStubServerSmokeE2ETests
{
    // ========================================================================
    // SquidHalibutStubServer_Start_ExposesUrisAndThumbprint
    //
    ...
    [Fact]
    public async Task SquidHalibutStubServer_Start_ExposesUrisAndThumbprint()
    {
        ...
        server.PollingUri.ShouldNotBeNull(
            customMessage: "SquidHalibutStubServer.PollingUri MUST be set after StartAsync — Halibut polling listener bind failed?");
