...
/// Windows.</para>
/// </summary>
public sealed class SquidHalibutStubServer : IAsyncDisposable
{
    ...
    private SquidHalibutStubServer(X509Certificate2 cert, HalibutRuntime runtime, int pollingPort, HttpListener httpListener, int serverPort, CancellationTokenSource httpLoopCts)
    {
        _serverCert = cert;
        _runtime = runtime;
    ...
    /// </summary>
    public static async Task<SquidHalibutStubServer> StartAsync()
    {
        ...
        var server = new SquidHalibutStubServer(cert, runtime, assignedPollingPort, httpListener, serverPort, httpLoopCts);
