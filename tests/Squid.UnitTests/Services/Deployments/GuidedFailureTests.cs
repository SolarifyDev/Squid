...
public class GuidedFailureTests
{
    ...
    public async Task GuidedFailure_Retry_ReExecutesAction()
    {
        ...
        interruptionService.Setup(s => s.CreateInterruptionAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(new DeploymentInterruption { Id = 1 });
        interruptionService.Setup(s => s.WaitForResolutionAsync(1, It.IsAny<CancellationToken>()))
            .ReturnsAsync(GuidedFailureAction.Retry);
    ...
    public async Task GuidedFailure_Skip_ContinuesWithoutFailure()
    {
        ...
        interruptionService.Setup(s => s.CreateInterruptionAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(new DeploymentInterruption { Id = 1 });
        interruptionService.Setup(s => s.WaitForResolutionAsync(1, It.IsAny<CancellationToken>()))
            .ReturnsAsync(GuidedFailureAction.Skip);
    ...
    public async Task GuidedFailure_Abort_Throws()
    {
        ...
        interruptionService.Setup(s => s.CreateInterruptionAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(new DeploymentInterruption { Id = 1 });
        interruptionService.Setup(s => s.WaitForResolutionAsync(1, It.IsAny<CancellationToken>()))
            .ReturnsAsync(GuidedFailureAction.Abort);
    ...
    public async Task GuidedFailure_Disabled_ThrowsDirectly()
    {
        ...
        interruptionService.Verify(s => s.CreateInterruptionAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<CancellationToken>()), Times.Never);
    }
