...
Console.WriteLine("Squid.WindowsUpgradeE2E.VersionStampedShim — version-stamped shim for the upgrade E4.h short-circuit test. This binary does nothing functional; it exists only to provide a Squid.Tentacle.exe with a known ProductVersion for `Get-Item.VersionInfo` to inspect.");
return 0;
