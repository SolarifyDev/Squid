...
public class IntegrationDeploymentTaskBackgroundService : IntegrationTestBase
{
    public IntegrationDeploymentTaskBackgroundService(IntegrationFixture fixture) : base(fixture)
    {
    }
    ...
    private async Task PrepareDeploymentDataAsync()
    {
        await Run<IRepository, IUnitOfWork>(async (repository, unitOfWork) =>
        {
            ...
            var process = new DeploymentProcess
            {
                ...
                Description = "Test deployment process for integration test",
                SpaceId = 1,
            ...
            var machine = new Machine
            {
                ...
                DeploymentTargetType = "ListeningTentacle",
                DataVersion = Array.Empty<byte>(),
                SpaceId = 1,
