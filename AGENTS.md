...
| `~/.Codex/AGENTS.md` Rule 12 | The fidelity tiers + canonical E2E test pattern. Every new E2E follows this shape. |
| `~/.Codex/AGENTS.md` Rule 9 | Three-tier coverage requirement (Unit + Integration + E2E). |
...
See `~/.Codex/AGENTS.md` for global rules (no breaking changes, design principles, refactoring patterns).
